...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        Transition reEnterTransition = new AutoTransition();
        Transition returnTransition = new DetailsTransition();

        int id = item.getItemId();

        if (id == R.id.nav_camera) {
            // Handle the camera action
            Fragment4Boxes fragment = Fragment4Boxes.newInstance();
            ...
            FramgnetOneBox fragment = new FramgnetOneBox();
